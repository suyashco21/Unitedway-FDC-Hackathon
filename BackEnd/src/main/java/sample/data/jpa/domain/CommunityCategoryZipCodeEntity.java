...
@Entity(name = "COMMUNITY_MEASURE_ZIPCODE_CATEGORY_MASTER")
public class CommunityCategoryZipCodeEntity implements Serializable{
	...
	@Id
	@GeneratedValue
	@Column(name = "COMMUNITY_CATEGORY_ID", unique = true, length = 100, nullable = false)
	private Long id;
	
	@Column(name = "COMMUNITY_CATEGORY_NAME", length = 100, nullable = false)
